...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {-18, 19, 17}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {15, -11, -13}; // Ports, the first number will be used for sensing
...
#define RIGHT_JOYSTICK  pros::E_CONTROLLER_ANALOG_RIGHT_Y   // This is the "forward" stick
#define LEFT_JOYSTICK pros::E_CONTROLLER_ANALOG_LEFT_X  // This is the "turning" stick
/*
//
// Tank Control...
...
const bool  CURVE_TYPE         = false;  // true is red, false is blue in the demos link above
...
const double STARTING_LEFT_CURVE_SCALE  = 13.5;     // Starting value for curve (if 0, linear graph)
const double STARTING_RIGHT_CURVE_SCALE = 0;     // Starting value for curve (if 0, linear graph) (disabled when TANK_CONTROL = false)
const double CURVE_MODIFY_INTERVAL      = 0.15;   // When you modify the scaler with the controller, it will increase/decrease by this interval
