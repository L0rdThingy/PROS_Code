...
auto_select(bool is_auton) {
  ...
  switch (current_page) {
    case 0: // Auto 1
      ...
      break;
    case 1: // Auto 2
      pros::lcd::set_text(1, "Left and Tree");
      if (is_auton) left_tree_40();
      break;
    case 2: // Auto 3
      pros::lcd::set_text(1, "Right and Tree");
      if (is_auton) right_tree_40();
      break;
    case 3: // Auto 4
      pros::lcd::set_text(1, "Auton 3");
      if (is_auton) left_lwp_29();
      break;
    case 4: // Auto 5
      pros::lcd::set_text(1, "Auton 4");
      if (is_auton) right_rwp_41();
      break;
    case 5: // Auto 6
...
initialize() {
  ...
  if(!imu_calibrate()) {
    pros::lcd::set_text(7, "Jay did not do your mom!");
  }
  if(imu_calibrate()) {
    pros::lcd::set_text(6, "Jay did do your mom!");
  }
